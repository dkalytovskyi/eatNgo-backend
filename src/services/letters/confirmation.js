const confirmLetter = (firstName, lastName, link) => {
    return `
    ...
    <tbody>
        <tr>
          <td style="font-size: 18px; margin-bottom: 30px; display: block; color: #000; font-weight: bold; text-align: center; line-height: 26px;">
           <strong>${firstName} ${lastName} </strong>
          </td>
        </tr>
        <tr>
          <td style="font-size: 14px; color: #000; text-align: center; line-height: 22px;">
             Thanks for your registration.<br>
             Please click to this link to complete your activation.
          </td>
        </tr>
        <tr>
